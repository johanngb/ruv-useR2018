How to remove unwanted variation from transcriptomics data using RUV4
================
...
-   [Remove batch effects using RUV-4](#remove-batch-effects-using-ruv-4)
    ...
    -   [P-value distributions for unadjusted and RUV4-adjusted data sets](#p-value-distributions-for-unadjusted-and-ruv4-adjusted-data-sets)
...
![](RUV_tutorial_batchCorrection_RUV4_files/figure-markdown_github/unnamed-chunk-4-4.png)
